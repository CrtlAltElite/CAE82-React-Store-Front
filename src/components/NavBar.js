    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open} >
        <Toolbar>
          ...
          <Box sx={{mr:3}}>
            <img height='45px' className='p2' src="https://res.cloudinary.com/cae67/image/upload/v1645745831/rainbow-unicorn-poop-emoji-graphics-art-coffee-cup-plant-transparent-png-1177964_w6m1jf.png"/>
          </Box>
